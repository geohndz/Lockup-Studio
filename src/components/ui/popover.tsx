  ...
  return (
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        ...
        className={cn(
          "z-50 w-auto origin-(--radix-popover-content-transform-origin) rounded-[var(--bk-radius-card)] bg-[var(--bk-card)] text-[var(--bk-ink)] shadow-[var(--bk-shadow-dialog)] outline-none",
